...
class SumTest < Minitest::Test
  ...
  def test_sum_to_1000
    assert_equal 233_168, SumOfMultiples.new().to(1000)
  end
  ...
  def test_sum_to_1
    assert_equal 0, SumOfMultiples.new().to(1)
  end

  def test_sum_to_3
    assert_equal 3, SumOfMultiples.new().to(4)
  end
  ...
  def test_sum_to_100
    assert_equal 2_318, SumOfMultiples.new().to(100)
  end
end